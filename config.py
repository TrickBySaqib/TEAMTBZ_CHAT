...
SUPPORT_GRP = getenv("SUPPORT_GRP", "ll_Bot_Support_ll")
UPDATE_CHNL = getenv("UPDATE_CHNL", "ll_Bot_Promotion_ll")
OWNER_USERNAME = getenv("OWNER_USERNAME", "lll_Oye_Zayn_lll")
